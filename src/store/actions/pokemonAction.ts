...
export const SET_LOAD_MORE_API_CALL_INPROGRESS =
  "SET_LOAD_MORE_API_CALL_INPROGRESS";
export const SET_FILTERED_POKEMON_LIST = "SET_FILTERED_POKEMON_LIST";
export const SET_POKEMON_TYPE = "SET_POKEMON_TYPE";
export const SET_POKEMON_GENDER_LIST = "SET_POKEMON_GENDER_LIST";
